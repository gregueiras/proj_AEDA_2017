...
bool Address::cityToGPS()
{
	...
	city_gps.push_back(make_pair("Braganca", GPS(41.80580559843144, -6.756677627563477)));
	...
	city_gps.push_back(make_pair("evora", GPS(38.5705822976803, -7.912559509277344)));
	...
	city_gps.push_back(make_pair("Santarem", GPS(39.23610907709813, -8.685894012451172)));
	city_gps.push_back(make_pair("Setubal", GPS(38.525405818058374, -8.89068603515625)));
